...
import 'package:flutter_drawing_board/pages/drawing_page/widgets/color_palette.dart';
            ...
            Wrap(
              children: [
                ValueListenableBuilder<bool>(
                  valueListenable: undoRedoManager.value.canUndo,
                  builder: (_, canUndo, __) {
                    return TextButton(
                      onPressed:
                          canUndo ? () => undoRedoManager.value.undo() : null,
                      child: const Text('Undo'),
                    );
                  },
                ),
                ValueListenableBuilder<bool>(
                  valueListenable: undoRedoManager.value.canRedo,
                  builder: (_, canRedo, __) {
                    return TextButton(
                      onPressed:
                          canRedo ? () => undoRedoManager.value.redo() : null,
                ...
                TextButton(
                  ...
                  onPressed: () => undoRedoManager.value.clear(),
                ),
              ],
            ),
          ],
